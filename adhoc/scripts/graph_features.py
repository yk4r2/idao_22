...
from adhoc.scripts.utils import structures_to_df, RootPath
...
def main() -> None:
    ...
    root_public_path = RootPath('data/dichalcogenides_public', must_exist=True)
    root_private_path = RootPath('data/dichalcogenides_private', must_exist=True)
